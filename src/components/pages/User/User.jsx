            ...
            <div className="userContainer">
                <div className="userShow">
                    <div className="userShowTop">
                        <img src={myImage} alt="" className="userShowImg" />
                    ...
                    <div className="userShowButtom">
                        ...
                        <div className="userShowInfo">
                            ...
                            <span className="userShowInfoTitle">12/12/2000</span>
                        </div>
                        <span className="userShowTitle">Contact Details</span>
                        <div className="userShowInfo">
                            <PhoneAndroid className="userShowIcon" />
                            <span className="userShowInfoTitle">+234 816 686 9151</span>
                        </div>
                        <div className="userShowInfo">
                    ...
                    <form className="userUpdateForm">
                        <div className="userUpdateLeft">
                            ...
                            <div className="userUpdateItem">
                                ...
                                <input type="text" placeholder="+234 816 686 9151" className="userUpdateInput" />
                            </div>
                            <div className="userUpdateItem">
                                <label>Address</label>
                        ...
                        <div className="userUpdateRight">
                            <div className="userUpdateUpload">
                                <img src={myImage} className="userUpdateImg" alt="" />
                                <label htmlFor="file">
